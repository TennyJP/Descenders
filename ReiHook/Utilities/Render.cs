...
namespace ReiHook.Utilities
{
    public static class Render
    {
        ...
        public static Vector3 WorldToScreenPoint(Vector3 wp) {
            ...
            Matrix4x4 mat = Camera.current.projectionMatrix * Camera.current.worldToCameraMatrix;
            ...
            temp.x *= invw;
            temp.y *= invw;
            Vector2 Center = new Vector2((0.5f * Camera.current.pixelWidth), (0.5f * Camera.current.pixelHeight));
            Center.x += 0.5f * temp.x * Camera.current.pixelWidth + 0.5f;
            Center.y -= 0.5f * temp.y * Camera.current.pixelHeight + 0.5f;
